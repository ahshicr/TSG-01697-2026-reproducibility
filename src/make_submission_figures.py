...
def main() -> int:
    ...
    system_contract = {
        ...
        "generation": "OpenAI native image generation and editing with manuscript-specific labels. A local-label edit on 2026-09-05 replaced Central PC with Protected PC. All labels, scientific connections and the separate-experiment boundary were visually checked. Raster pixels outside the label are not asserted identical. The native model version was not supplied.",
    }
