...
%DIFDELCMD < \end{table}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \input{table_real_ev_forecast}
\DIFaddend 
...
\DIFdelFL{30}\DIFdelendFL \DIFaddbeginFL \input{table_policy_definitions}
...
%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
\DIFdelend \DIFaddbegin \input{table_objective_sensitivity}
\DIFaddend 
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth,trim=90 85 90 90,clip]{f1.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{fig_operational_evidence.pdf}
...
\DIFdelbegin %DIFDELCMD < \begin{figure}[t]
%DIFDELCMD < \centering
%DIFDELCMD < \includegraphics[width=0.98\linewidth]{fig_policy_bubbles.pdf}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \input{table_integrated_execution}
\DIFaddend 
...
\DIFdelbegin %DIFDELCMD < \begin{figure}[t]
%DIFDELCMD < \centering
%DIFDELCMD < \includegraphics[width=0.98\linewidth]{fig_smartgrid_stress.pdf}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
restoration toward zones likely to transmit disturbance across domains.  }\DIFdelend \DIFaddbegin \section{\DIFadd{Interpretation and Reproducibility}}
\DIFaddend 

\DIFdelbegin \DIFdel{Changing the restoration budget }\DIFdelend \DIFaddbegin \subsection{\DIFadd{Result interpretation}}
