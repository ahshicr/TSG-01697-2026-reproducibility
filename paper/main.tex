...
dispatched work orders, and integer repair completion.
...
results.  Section IV describes the empirical study and its results.  Section V
interprets the evidence and states data availability.  Section VI concludes the
paper.
...
\caption{Executable PC closed loop.  Boulder charging sessions supply measured
...
A public repository provides the code, processed inputs, scenario level
